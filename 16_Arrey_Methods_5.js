...
//splice()
let student1 = ['mayuri', 'ankita', 'rohan', 'sham', 'radha','komal','bharti']
                //  0         1        2       3      4
...
let y2=student1.splice(2,3)
console.log(y2)
console.log(student1)

let u1=student1.splice(0,1,'sanchita','pranali','rahul')
console.log(u1)
console.log(student1)
...
let s34=numbers.fill('mayuri', 2, 4)
console.log(s34)
console.log(numbers)
